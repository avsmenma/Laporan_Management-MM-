...
class InvestasiService
{
    ...
    public function rekap2Columns(): array
    {
        return [
            ...
            ['key' => 'sa_borrowing', 'title' => 'Borrowing', 'group' => 'Saldo Awal'],
            ...
            ['key' => 'pn_borrowing', 'title' => 'Borrowing', 'group' => 'Penambahan Tahun Ini'],
            ...
            ['key' => 'pg_borrowing', 'title' => 'Borrowing', 'group' => 'Pengurangan Tahun Ini'],
            ...
            ['key' => 'sk_borrowing', 'title' => 'Borrowing', 'group' => 'Saldo Akhir'],
